...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-red-900 p-4">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center">
              <Link href="/login" className="text-sm text-heartmail-pink hover:underline font-medium flex items-center justify-center space-x-1">
