-- Complete Subscription Setup for HeartMail
...
DROP POLICY IF EXISTS "System can insert usage records" ON subscription_usage;
DROP POLICY IF EXISTS "Users can view their own billing history" ON billing_history;
DROP POLICY IF EXISTS "System can insert billing records" ON billing_history;
...
-- ==============================================
-- STEP 6: CREATE TRIGGERS (DROP IF EXISTS FIRST)
-- ==============================================
